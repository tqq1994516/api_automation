...
datas = {
    # 发布会表数据
    'vcom_bancard_thermal_record': [
        {'id': '1', 'school_id': '1101010001', 'grade_id': '0012', 'class_id': '157767527483843139',
         'student_number': '110101000100841',
         'thermal_serial': '301F9A68F98A', 'day': '2020-06-29', 'temp': '36.9', 'status': 0},
